...
(5030, '监控运维', '', 1, 5030, 5000, '', 'ant-design:monitor-outlined', '', '', 0, 0, 0, 0, '1', NOW(), '1', NOW(), 0),
(5031, 'Agent 健康看板', 'vos:agent:health', 2, 5031, 5030, '/vos/agent-health', 'ant-design:heart-outlined', 'views/vos/agent-health/index.vue', 'VOSAgentHealth', 0, 0, 0, 0, '1', NOW(), '1', NOW(), 0),
(5032, '监控大屏', 'vos:monitor:screen', 2, 5032, 5030, '/vos/monitor', 'ant-design:dashboard-outlined', 'views/monitor/index.vue', 'VOSMonitor', 0, 0, 0, 0, '1', NOW(), '1', NOW(), 0),
(5040, '财务管理', '', 1, 5040, 5000, '/finance', 'ant-design:accountbook-outlined', '', '', 0, 0, 0, 0, '1', NOW(), '1', NOW(), 0),
...
(5043, '报表', 'finance:report:list', 2, 5043, 5040, '/finance/report', 'ant-design:file-text-outlined', 'views/finance/report/index.vue', 'FinanceReport', 0, 0, 0, 0, '1', NOW(), '1', NOW(), 0),
